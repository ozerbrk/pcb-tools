...
hints = [
    ...
    Hint(layer='internal',
         ...
         keywords=['internal', 'in1.cu', 'in2.cu', 'in3.cu', 'in4.cu', 'inner1', 'inner2', 'inner3', 'inner4', 'inner5', 'inner6', 'copper_inner', 'in', 'gt1', 'gt2', 'gt3', 'gt4', 'gt5', 'gt6', 'g1', 'g2', 'g3', 'g4', 'g5', 'g6', 'inner']),
    Hint(layer='bottom',
